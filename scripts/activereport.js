...
{ 
    var ret = "<reportrow2><rowdata><rowitem id='name'><input id='activereportfilter' class='activereportfilter' onKeyUp='filterReportData()' type='text' /></rowitem><rowitem id='branch'></rowitem></rowdata><rowcheckboxes>";
